...
import com.bigkoo2.pickerview2.R;
...
/**
 * 时间选择器
 * create time onon 15/11/22.
 * Updated by create time on on 2017-2-22.
 */
...
//        wheelTime.setLabels(label_year, label_month, label_day, label_hours, label_mins, label_seconds);
    ...
    public void setLabelStr(Context context) {
        TextView mYearStr = (TextView) findViewById(R.id.year_str_tv);
        TextView mMonthStr = (TextView) findViewById(R.id.month_str_tv);
        TextView mDayStr = (TextView) findViewById(R.id.day_str_tv);
        TextView mHourStr = (TextView) findViewById(R.id.hour_str_tv);
        TextView mMinStr = (TextView) findViewById(R.id.min_str_tv);
        TextView mSecondStr = (TextView) findViewById(R.id.second_str_tv);
        if (TextUtils.isEmpty(label_year)) {
            mYearStr.setText(context.getResources().getString(R.string.pickerview_year));
        }
        if (TextUtils.isEmpty(label_month)) {
            mMonthStr.setText(context.getResources().getString(R.string.pickerview_month));
        }
        if (TextUtils.isEmpty(label_day)) {
            mDayStr.setText(context.getResources().getString(R.string.pickerview_day));
        }
        if (TextUtils.isEmpty(label_hours)) {
            mHourStr.setText(context.getResources().getString(R.string.pickerview_hours));
        }

        if (TextUtils.isEmpty(label_mins)) {
            mMinStr.setText(context.getResources().getString(R.string.pickerview_minutes));
        }

        if (TextUtils.isEmpty(label_seconds)) {
            mSecondStr.setText(context.getResources().getString(R.string.pickerview_seconds));
        }
        ...
        switch (type) {
            ...
            case YEAR_MONTH_DAY:
               /* textSize = textSize * 4;*/
                ...
                mMinStr.setVisibility(View.GONE);
                mSecondStr.setVisibility(View.GONE);
                break;
            case HOURS_MINS:
                /*textSize = textSize * 4;*/
                mYearStr.setVisibility(View.GONE);
                mMonthStr.setVisibility(View.GONE);
                mDayStr.setVisibility(View.GONE);
                mSecondStr.setVisibility(View.GONE);
                break;
