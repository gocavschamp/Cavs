...
public class GridImageAdapter extends
    ...
    public void onBindViewHolder(final ViewHolder viewHolder, final int position) {
        ...
        if (getItemViewType(position) == TYPE_CAMERA) {
            viewHolder.mImg.setImageResource(R.drawable.jpush_ic_action_close);
            ...
            if (chooseModel == PictureMimeType.ofAudio()) {
                ...
                Glide.with(viewHolder.itemView.getContext())
                        .load(PictureMimeType.isContent(path) && !media.isCut() && !media.isCompressed() ? Uri.parse(path)
                                : path)
                        .centerCrop()
                        .placeholder(R.color.color_ff3d4353)
...
//                    mItemLongClickListener.onItemLongClick(viewHolder, adapterPosition, v);
    ...
    private QrcodeZxingDemoActivity.OnItemLongClickListener mItemLongClickListener;

    public void setItemLongClickListener(QrcodeZxingDemoActivity.OnItemLongClickListener l) {
