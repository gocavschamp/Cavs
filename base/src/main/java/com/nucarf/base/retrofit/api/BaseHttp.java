...
//        baseParams.put("ver", BaseAppCache.getVersion_code());
    ...
    public static Map<String, String> getTokenParams() {
        ...
        map.put("token", SharePreUtils.getjwt_token(mContext));
        String sign = MD5Utils.getSign(map, "wxw");
        SharePreUtils.setSign(mContext, sign);
        return map;
    }
//    public static Map<String, String> getTokenParams(String...params) {
//        Context context = BaseAppCache.getContext();
//        Map<String, String> map = new TreeMap<String, String>();
//        for (int i = 0; i < params.length; i++) {
//            map.put(""+params[i],params[i])
//        }
//        map.put("deviceId", "" + AndroidUtil.getDeviceId(context));
//        map.put("token", SharePreUtils.getjwt_token(context));
//        String sign = MD5Utils.getSign(map, "wxw");
//        SharePreUtils.setSign(context, sign);
//        return map;
//    }
