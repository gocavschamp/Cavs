...
//      builder.writeTimeout(Config.HTTP_WRITE_TIMEOUT, TimeUnit.MILLISECONDS);
//      builder.cache(new okhttp3.Cache(StarshowApplication.getContext().getCacheDir(), Config.RESPONSE_CACHE_SIZE));
...
//      builder.addInterceptor(httpLoggingInterceptor);
        ...
        File cacheFile = new File(BaseAppCache.getContext().getExternalCacheDir(), "starshowCache");
